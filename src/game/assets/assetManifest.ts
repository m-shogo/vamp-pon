...
export const assetManifest: AssetManifestEntry[] = [
  ...
  {
    id: 'top_stage1_background',
    path: '/assets/prototypes/backgrounds/stage-01/environment-master.png',
    width: 390,
    height: 844,
    kind: 'ui',
    description: 'TOPで使う忘れられた夜路の背景。Stage1背景を暗幕付きで再利用。',
    required: false,
    fallback: false,
  },
  {
    id: 'top_yui_fullbody',
    path: '/assets/prototypes/ui/top/yui-fullbody-standing-runtime-v1.png',
    width: 760,
    height: 1186,
    kind: 'ui',
    description: 'TOPで使うユイ全身立ち絵。参照画像から透明化したruntime UI部品。',
    required: false,
    fallback: false,
  },
  {
    id: 'ui_paper_title_banner_v1',
    path: '/assets/prototypes/ui/generated/paper-title-banner-v1.png',
    width: 1208,
    height: 435,
    kind: 'ui',
    description: 'TOP/非戦闘UIで使う生成紙札タイトルバナー。文字はruntime Textで描画。',
    required: false,
    fallback: false,
  },
  {
    id: 'ui_paper_cta_button_v1',
    path: '/assets/prototypes/ui/generated/paper-cta-button-v1.png',
    width: 965,
    height: 263,
    kind: 'ui',
    description: 'TOP/非戦闘UIで使う生成紙CTAボタン。文字はruntime Textで描画。',
    required: false,
    fallback: false,
  },
  {
    id: 'ui_paper_small_card_v1',
    path: '/assets/prototypes/ui/generated/paper-small-card-v1.png',
    width: 406,
    height: 396,
    kind: 'ui',
    description: 'TOP/図鑑/ステージ選択で使う生成紙カード台紙。文字はruntime Textで描画。',
    required: false,
    fallback: false,
  },
  {
    id: 'ui_wax_seal_badge_v1',
    path: '/assets/prototypes/ui/generated/wax-seal-badge-v1.png',
    width: 326,
    height: 326,
    kind: 'ui',
    description: 'TOP/非戦闘UIで使う生成封蝋バッジ。通知や選択印として使用。',
    required: false,
    fallback: false,
  },
