...
export const YUI_GAMEPLAY_FRAME_ASSETS = [
  ...
  // 入力方向と手持ちランタンの見え方が一致する歩行セルを割り当てる。
  { id: YUI_FRAME_IDS.walk.left[0], path: `${ROOT}/10_r02_c03_walk_left_a.png`, width: 180, height: 180, kind: 'player', description: 'ユイ Core5 left walk A', required: false, fallback: true },
  { id: YUI_FRAME_IDS.walk.left[1], path: `${ROOT}/11_r02_c04_walk_left_b.png`, width: 180, height: 180, kind: 'player', description: 'ユイ Core5 left walk B', required: false, fallback: true },
  { id: YUI_FRAME_IDS.walk.right[0], path: `${ROOT}/12_r02_c05_walk_right_a.png`, width: 180, height: 180, kind: 'player', description: 'ユイ Core5 right walk A', required: false, fallback: true },
  { id: YUI_FRAME_IDS.walk.right[1], path: `${ROOT}/13_r02_c06_walk_right_b.png`, width: 180, height: 180, kind: 'player', description: 'ユイ Core5 right walk B', required: false, fallback: true },
