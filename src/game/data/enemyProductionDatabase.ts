...
export const enemyProductionEntries: EnemyProductionEntry[] = [
  ...
  { id: 'boss_name_without_owner', no: 46, name: '持ち主のない名前', rank: 'boss', family: 'great_shadow', readableRole: '名前テーマ大ボス。', wrongReading: '名前だけが残り、誰のものか分からない', releasedClue: '誰かの名前札', movement: '重く中央へ寄る', attackCue: '無数の名札が黒く貼りつく', silhouette: '大きな影に名札片が何枚も浮く', palette: ['ink black', 'paper cream', 'dawn pink'], stageAffinity: ['forgotten_street', 'name_tag_alley'], dropHint: '忘れ物', assetKeywords: ['great shadow boss', 'many name tags', 'ownerless name'] },
