...
export const ACHIEVEMENT_DEFS: readonly AchievementDef[] = [
  ...
  { id: 'no-berserk:s1:shallow', title: '黒に頼らない', description: '黒耀化せずに、最初の夜明けへたどり着く。', category: 'challenge', reward: 25 },
  { id: 'no-berserk:s1:middle', title: '黒に頼らない（中層）', description: '黒耀化せずに、中層の夜路を越える。', category: 'challenge', reward: 30 },
  { id: 'no-berserk:s1:deep', title: '黒に頼らない（深層）', description: '黒耀化せずに、深層の夜明けを迎える。', category: 'challenge', reward: 35 },
  { id: 'no-berserk:s2:shallow', title: '雨に頼らない', description: '黒耀化せずに、雨ににじむ二夜目を越える。', category: 'challenge', reward: 30 },
