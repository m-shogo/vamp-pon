...
export const weapons: WeaponDefinition[] = [
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 2, effect: { type: 'projectile', damage: 50, projectiles: 5, cooldown: 0.6, pierce: 5, targeting: 'nearest', evolved: true }, label: '線が太くなり、影をまとめて貫く。' },
      { level: 3, effect: { type: 'projectile', damage: 60, projectiles: 6, cooldown: 0.55, pierce: 6, targeting: 'nearest', evolved: true }, label: '一行が終わらず、夜を書き続ける。' },
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 2, effect: { type: 'radial_random_projectile', damage: 26, projectiles: 14, cooldown: 0.78, speed: 1.65, evolved: true }, label: '星弾がもう少し多く、速くなる。' },
      { level: 3, effect: { type: 'radial_random_projectile', damage: 32, projectiles: 16, cooldown: 0.7, speed: 1.75, evolved: true }, label: '夜空が星弾でいっぱいになる。' },
    ],
  },
  {
    id: 'dawn_ink_lamp',
    ...
    levels: [
      ...
      { level: 2, effect: { type: 'ground_area', damagePerSecond: 34, duration: 7.0, radius: 140, cooldown: 1.05, maxAreas: 4, targeting: 'nearest', evolved: true }, label: '輪が一回り広がり、置ける数も増える。' },
      { level: 3, effect: { type: 'ground_area', damagePerSecond: 42, duration: 7.5, radius: 152, cooldown: 0.95, maxAreas: 5, targeting: 'nearest', evolved: true }, label: '夜明けの輪が夜じゅうを照らす。' },
    ],
  },
  {
    id: 'unforgotten_name',
    ...
    levels: [
      ...
      { level: 2, effect: { type: 'projectile', damage: 72, projectiles: 4, cooldown: 0.52, pierce: 10, targeting: 'nearest', evolved: true }, label: '名前が太く、影をまとめて貫く。' },
      { level: 3, effect: { type: 'projectile', damage: 88, projectiles: 5, cooldown: 0.46, pierce: 12, targeting: 'nearest', evolved: true }, label: '名前は途切れず、夜を貫き続ける。' },
    ],
  },
  {
    id: 'memory_marble',
    ...
    levels: [
      ...
      { level: 2, effect: { type: 'bouncing_projectile', damage: 28, projectiles: 4, cooldown: 0.82, bounces: 7, speed: 1.55, duration: 7.0, evolved: true }, label: 'ビー玉が増えて長く跳ねる。' },
      { level: 3, effect: { type: 'bouncing_projectile', damage: 34, projectiles: 5, cooldown: 0.74, bounces: 8, speed: 1.65, duration: 7.5, evolved: true }, label: '景色全部がビー玉の光に染まる。' },
    ],
  },
  {
    ...
    levels: [
      ...
      { level: 2, effect: { type: 'projectile', damage: 40, projectiles: 6, cooldown: 0.66, pierce: 4, targeting: 'nearest', evolved: true }, label: '紙刃が増え、影を斜めに切り抜ける。' },
      { level: 3, effect: { type: 'projectile', damage: 48, projectiles: 7, cooldown: 0.6, pierce: 5, targeting: 'nearest', evolved: true }, label: '封の言葉が夜じゅうに届く。' },
    ],
  },
  {
    id: 'tailwind_plane',
    ...
    levels: [
      ...
      { level: 2, effect: { type: 'bouncing_projectile', damage: 24, projectiles: 6, cooldown: 0.92, bounces: 6, speed: 1.35, duration: 7.5, evolved: true }, label: '機数が増え、夜風が強くなる。' },
      { level: 3, effect: { type: 'bouncing_projectile', damage: 28, projectiles: 7, cooldown: 0.84, bounces: 7, speed: 1.45, duration: 8.0, evolved: true }, label: '夜全体が紙ひこうきで埋まる。' },
    ],
  },
];
