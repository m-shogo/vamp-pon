...
export const worldSettingConflictEntries: readonly WorldSettingConflictEntry[] = [
  { id: 'CF-001', label: 'Current21 era mismatch', status: 'GUARDED', guard: 'Reality era and Dream co-presence remain separate facts; exact time tags are weak inside Yoru-no-Shirube.', humanDecisionRequired: false },
  ...
  { id: 'CF-019', label: 'Dream materialization versus wish-solves-plot', status: 'GUARDED', guard: 'Food, drink, daily goods and rest may be dream-materialized; minds, consent, trauma, memory truth, Black Youka and Reality incidents cannot be wished away.', humanDecisionRequired: false },
