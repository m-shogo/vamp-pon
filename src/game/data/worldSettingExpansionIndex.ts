...
export const worldSettingExpansionEntries: readonly WorldSettingExpansionEntry[] = [
  ...
  { id: 'life-death-waking-rulebook', priority: 'P0', label: 'Life / Death / Injury / Waking Rulebook', primarySource: 'docs/world-life-death-injury-rulebook-v1.md', authority: 'WORLD_SETTING_EXPANSION_SOURCE', runtimeAutoPromotionAllowed: false, humanReviewRequiredForFinalCanon: true },
  { id: 'sakuyaza-operational-assets', priority: 'P0', label: '朔夜座 Operational Assets / Legacy Sakumei Migration', primarySource: 'docs/sakumei-operational-bible-candidate-v1.md', authority: 'WORLD_SETTING_EXPANSION_SOURCE', runtimeAutoPromotionAllowed: false, humanReviewRequiredForFinalCanon: true },
  ...
  { id: 'world-economy', priority: 'P1', label: 'Reality Economy / Dream Living Separation', primarySource: 'docs/world-civilian-society-bible-v1.md', authority: 'WORLD_SETTING_EXPANSION_SOURCE', runtimeAutoPromotionAllowed: false, humanReviewRequiredForFinalCanon: true },
