...
function loadAuthorOverviewDashboard() {
  if (document.querySelector('script[data-author-dashboard-loader]')) return;
  const script = document.createElement('script');
  script.src = './author-dashboard-enhancement.js';
  script.defer = true;
  script.dataset.authorDashboardLoader = 'true';
  document.body.append(script);
}

bootProfiles();
loadAuthorOverviewDashboard();
