...
for (const token of [
  ...
  'Mathf.PerlinNoise(11.17f, time * .0125f)',
  'Mathf.PerlinNoise(29.53f, time * .0047f)',
  'Mathf.PerlinNoise(13.61f, time * .0091f)',
  'Mathf.PerlinNoise(17.29f, time * .0215f)',
  'Mathf.PerlinNoise(37.11f, time * .0083f)',
  'Mathf.PerlinNoise(19.87f, time * .0163f)',
