...
2. Unity HubでUnity 6 LTS patchを確認する。
3. `unity/VampPonUnity/` に2D URP projectを作る。
4. `Library/`, `Logs/`, `UserSettings/`, `.sln`, `.csproj` がgit管理外であることを確認する。
5. Boot / Stage1 sceneを作る。
6. 390x844縦画面、SafeAreaCanvas、dark paper背景を作る。
7. Yui placeholder、Ombu placeholder、lantern glow、EXP fragment吸引placeholderを入れる。
8. ここで初回U1 commitにする。
