...
- ユイ×トモリ = same physical lantern object lineage / **not blood Canon**
- 現実では同時代とは限らない
- 物 / 記録 / 言葉は時代を渡れる
- 夜で初めて生まれる友情を残す
- 黒耀化 = 外部悪人格ではない
...
- Star Beast / constellation重複 = family / Named Object lineage / succession等の物語理由がある場合のみ
...
> **悲しい感情そのものではなく、出来事や自分自身へ付いた「一つの意味だけが正しい」状態が夜で固定化したもの。**
