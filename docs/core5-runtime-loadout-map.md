...
- `black_ink_bottle` 実素材: test-pack内の `weapon-black-ink-bottle-icon-v1-clean-1024-rgba.png` をmasterとして保持し、180px軽量版をruntime参照中prototypeへ昇格済み。Asset Factory上は approved / score 4 / Manual Issuesなし。
- `streetlamp_ring` 実素材: 現runtime参照中prototypeは180x180 RGBAで使用継続可能。ただし1024px master、64px/32px review、display-reviewが未整備のため、現時点では candidate keep / score 3 として扱う。
