...
実装・シナリオ・UI・アセット作成で迷った時は、この文書を最優先する。

古い検討メモと矛盾した時は、この文書と `docs/130` 以降の新しい文書を優先する。
...
```txt
P1では入れない。
将来的に bond / connection / pairSkill を足せる余地だけ残す。
```
