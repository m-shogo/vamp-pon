...
{
    public static class U45IosBuildGenerationPreflight
    {
        ...
        private const string OutputPath = "/Users/m-shogo/Developer/personal/vamp-pon-builds/ios-u45-app-quality-smoke";
        private const string EvidencePath = "../../docs/design-targets/generated/unity-u45/ios-build-generation-preflight.json";
        private const string LogPath = "Logs/u45_ios_build_generation_preflight_report.txt";

        [MenuItem("VampPon/U45/Run iOS Build Generation Preflight")]
        public static void Run()
        {
            ...
            File.WriteAllText(LogPath,
                "U45 iOS build generation preflight\n" +
                $"ready={ready}\n" +
                $"result={buildResult}\n" +
                $"errors={totalErrors}\n" +
        ...
        private static void WriteEvidence(bool ready, string error, string buildResult, int totalErrors, int totalWarnings)
        {
            var text =
                "{\n" +
                $"  \"generatedAt\": \"{DateTime.Now:yyyy-MM-dd}\",\n" +
                "  \"phase\": \"U45\",\n" +
                "  \"evidenceKind\": \"U45 iOS build generation preflight\",\n" +
