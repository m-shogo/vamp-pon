...
{
    public static class U2ScreenshotCapture
    {
        private const string BootScenePath = "Assets/_Project/Scenes/Boot/Boot.unity";
        private const string OutputDirectory = "../../docs/design-targets/generated/unity-u2";
        private const string StatePath = "Logs/u2_screenshot_state.txt";
        private const string ReportPath = "Logs/u2_screenshot_capture_report.txt";
        ...
        private readonly struct Profile
        {
            ...
            public string FileName => $"unity-u2-stage1-{Width}x{Height}.png";
        }
        ...
        {
            if (EditorApplication.timeSinceStartup - stepStartedAt > 22.0)
            {
            ...
            switch (step)
            {
                case CaptureStep.WaitForBattle:
                    if (SceneManager.GetActiveScene().name == "Stage1" &&
                        UnityEngine.Object.FindAnyObjectByType<U2BattleController>() != null &&
                        EditorApplication.timeSinceStartup - stepStartedAt > 4.2)
                    {
