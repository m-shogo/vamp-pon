...
{
    public static class U11PrefabComponentProofScreenshotCapture
    {
        private const string OutputDirectory = "../../docs/design-targets/generated/unity-u11/screenshots";
        private const string ReportPath = "Logs/u11_prefab_component_proof_screenshot_report.txt";
        ...
        public static void Run()
        {
            try
            {
                ...
                {
                    log.Add(Capture(p, $"u11-result-component-proof-{p.Width}x{p.Height}.png", BuildResultProof));
                    log.Add(Capture(p, $"u11-stageselect-component-proof-{p.Width}x{p.Height}.png", BuildStageSelectProof));
                }

                log.Add(Capture(new Profile(390, 844), "u11-kokuyou-rare-cutin-review-390x844.png", BuildKokuyouRareCutinReview));
        ...
        private static string Capture(Profile profile, string fileName, Action<RectTransform, AssetCache> build)
        {
            ...
            var camObj = new GameObject("U11Cam", typeof(Camera));
            created.Add(camObj);
            ...
            var canvasObj = new GameObject("U11Canvas", typeof(Canvas), typeof(CanvasScaler), typeof(GraphicRaycaster));
        ...
        private static void BuildResultProof(RectTransform root, AssetCache c)
        {
            ...
            ResultRootProof.Create(root, assets, sdfFont);
        }
        ...
        private static void BuildStageSelectProof(RectTransform root, AssetCache c)
        {
            var assets = new StageSelectProofAssets(
                ...
                c.S("U10Candidates/UI/result_continue_paper_button"));
            StageSelectRootProof.Create(root, assets, sdfFont);
        }
        ...
        private static void BuildKokuyouRareCutinReview(RectTransform root, AssetCache c)
        {
            ...
            Txt(root, "KA", "A: まとまり", -76f, 30f, 120f, 18f, 10f, PaleText);
            ...
            Txt(root, "RareCap", "rare: 特別だが黒耀化より弱い", -86f, -204f, 180f, 22f, 11f, PaleText);
            ...
            Txt(root, "CutinCap", "cut-in band", 86f, -160f, 140f, 20f, 10f, PaleText);
        }
