...
{
    public static class U1ScreenshotCapture
    {
        private const string BootScenePath = "Assets/_Project/Scenes/Boot/Boot.unity";
        private const string OutputDirectory = "../../docs/design-targets/generated/unity-u1-2";
        private const string StatePath = "Logs/u1_2_screenshot_state.txt";
        private const string ReportPath = "Logs/u1_2_screenshot_capture_report.txt";
        ...
        private readonly struct Profile
        {
            ...
            public string FileName => $"unity-u1-stage1-{Width}x{Height}.png";
        }
        ...
        private static void Update()
        {
            ...
            switch (step)
            {
                case CaptureStep.WaitForStage:
                    if (SceneManager.GetActiveScene().name == "Stage1" &&
                        GameObject.Find("SafeAreaCanvas") != null &&
                        GameObject.Find("YuiPlaceholder") != null)
                    {
                ...
                case CaptureStep.Capture:
                    if (EditorApplication.timeSinceStartup - stepStartedAt < 0.5)
                    {
                        return;
                    }
                    ...
                    captureLog.Add($"{captureProfile.Width}x{captureProfile.Height}: {captureProfile.FileName}, bytes={info.Length}, screen={Screen.width}x{Screen.height}");
                    profileIndex++;
        ...
        private static void Finish()
        {
            ...
            Debug.Log($"U1.2 screenshots captured. Report: {ReportPath}");
