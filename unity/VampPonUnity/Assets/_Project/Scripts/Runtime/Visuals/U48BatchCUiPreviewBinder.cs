    ...
    public sealed class U48BatchCUiPreviewBinder : MonoBehaviour
    {
        ...
        private static IEnumerable<Image> ResolveTargets(string group)
        {
            ...
            return group switch
            {
                ...
                "replacement-owned-slot-row" or "replacement-selected-slot-state" or "replacement-confirm-button" => Prefix("ReplacementSlotButton_"),
                ...
                "stage-select-stage-card" or "stage-select-locked-unlocked-state" or "stage-select-metadata-row" => Named("Stage1Card"),
