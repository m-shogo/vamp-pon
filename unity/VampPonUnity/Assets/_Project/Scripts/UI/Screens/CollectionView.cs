...
namespace VampPon.UnitySpike.UI.Screens
{
    public sealed class CollectionView : MonoBehaviour
    {
        ...
        public void Build(Transform parent, TMP_FontAsset uiFont, U46UiAssetCatalog catalog, CollectionPresenter collectionPresenter)
        {
            ...
            page = U46ScreenFactory.Panel(transform, "CollectionIndexPage", new Vector2(0.035f, 0.045f), new Vector2(0.965f, 0.955f), VisualBatchAssetProvider.Prefer(VisualBatchAssetProvider.CollectionPage, assets.Collection.Page), new Color(0.88f, 0.79f, 0.63f)).transform;
        ...
        private void Entry(CollectionEntryViewModel entry, int index)
        {
            ...
            var card = U46ScreenFactory.Button(indexRoot, $"Entry_{entry.Id}", string.Empty, entrySprite,
            ...
            if (entry.NewIndicator)
                U46ScreenFactory.Decoration(card.transform, "NewIndicator", VisualBatchAssetProvider.Prefer(VisualBatchAssetProvider.CollectionNewSeal, assets.Collection.NewBadge), new Vector2(0.86f, 0.84f), new Vector2(34f, 34f), Vector2.zero);
        }
        ...
        private void OpenDetail(string id)
        {
            ...
            detailOverlay = U46ScreenFactory.Panel(transform, "CollectionDetailOverlay", new Vector2(0.08f, 0.18f), new Vector2(0.92f, 0.82f), VisualBatchAssetProvider.Prefer(VisualBatchAssetProvider.CollectionDetailPage, assets.Result.MemoryPage), new Color(0.89f, 0.8f, 0.64f));
