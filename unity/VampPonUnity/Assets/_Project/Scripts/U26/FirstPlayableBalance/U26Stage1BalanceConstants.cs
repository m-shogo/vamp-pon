...
{
    public sealed class U26Stage1BalanceConstants
    {
        public const int StageClearSeconds = 480;
        public const int FirstLevelUpTargetSeconds = 30;
        public const int OpeningSafetySeconds = 30;
